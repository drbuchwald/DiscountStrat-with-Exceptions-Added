...
public class Receipt {
    ...
    public static final String ERROR_RECEIPT_NUMBER = "Receipt must have a number";
    public static final String ERROR_RECEIPT_DATE = "Receipt must have a date";
    ...
    public static int getReceiptNumber() {
        if(receiptNumber == 0){
            System.out.println(ERROR_RECEIPT_NUMBER);
        }
    ...
    public Date getDate() {
        if(receiptDate == null){
            System.out.println(ERROR_RECEIPT_DATE);
        }
        return receiptDate;
    }
